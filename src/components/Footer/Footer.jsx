  ...
  return (
    <div className="footer">
      ...
      <div className="f-content">
        <span style={{marginTop:'100px'}}>bansalpranav62@gmail.com</span>
        <span style={{marginTop:'100px'}}>+91-7827848707</span>
      <img src={Dog} alt="" style={{height:"35vh"}}></img>
        <div className="f-icons" style={{marginTop:'150px'}}>
          ...
          <Gitub color="white" size={"3rem"} onClick={()=> window.open("https://github.com/baansalpranav62", "_blank")} />
        </div>
      </div>
    </div>
  );
